...
public class UtilReportStore extends JFrame {
	...
	// control.add(this.label, new GridBagConstraints(0, 0, 1, 1, 0, 0, GridBagConstraints.WEST, GridBagConstraints.HORIZONTAL, new Insets(0, 0,
	// 0, 0), 0, 0));
	// control.add(this.text, new GridBagConstraints(1, 0, 1, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.HORIZONTAL, new Insets(0,
	// 0, 0, 0), 0, 0));
	// control.add(this.bFile, new GridBagConstraints(2, 0, 1, 1, 0, 0, GridBagConstraints.EAST, GridBagConstraints.HORIZONTAL, new Insets(0, 0,
	// 0, 0), 0, 0));
	// control.add(this.bRefresh, new GridBagConstraints(0, 3, 3, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(0, 0,
	// 0, 0), 0, 0));
	//
	...
	// FileReportStore.logger.warn("Found directory {} but NOT found report properties: {}", files[i], fProp);
	// continue;
	// }
	...
	// prop.load(fInProp);
	// BasicReportDefinition bd = new BasicReportDefinition(prop.getProperty(FileReportStore.PROPERTY_NAME), prop.getProperty(
	// FileReportStore.PROPERTY_DESCRIPTION, ""), prop.getProperty("entity"), null, prop.getProperty("query"),
