...
public class ToastMessage {
	 ...
	 * @param otherData
	 *            the other data
	 * @param bundleMessageParams
	 *            the bundle message params
	 * @param bundleDescriptionParams
	 *            the bundle description params
	 */
	public ToastMessage(Component parent, boolean blocking, String message, String description, ImageIcon icon, int animationTime, Rectangle windowBounds,
		...
		this.bundleMessageParams = bundleMessageParams == null ? null : Arrays.copyOf(bundleMessageParams, bundleMessageParams.length);
		this.bundleDescriptionParams = bundleDescriptionParams == null ? null : Arrays.copyOf(bundleDescriptionParams, bundleDescriptionParams.length);
	}
	...
	public ToastMessage(String msg, MessageType msgType, boolean blocking) {
		this(null, blocking, msg, null, null, ToastMessage.MESSAGE_TIME_SHORT, null, blocking ? ToastBlockingPanel.class : ToastNoblockingPanel.class, null, null, null);
	...
	public ToastMessage(Component parent, String msg, MessageType msgType, boolean blocking) {
		this(parent, blocking, msg, null, null, ToastMessage.MESSAGE_TIME_SHORT, null, blocking ? ToastBlockingPanel.class : ToastNoblockingPanel.class, null, null, null);
		this.setIconByType(msgType);
	}
	...
	public ToastMessage(String msg, Object[] msgParameters, MessageType msgType, boolean blocking) {
		this(null, blocking, msg, null, null, ToastMessage.MESSAGE_TIME_SHORT, null, blocking ? ToastBlockingPanel.class : ToastNoblockingPanel.class, null, msgParameters, null);
		this.setIconByType(msgType);
	}
	...
	public ToastMessage(String msg, ImageIcon ico, boolean blocking) {
		this(null, blocking, msg, null, ico, ToastMessage.MESSAGE_TIME_SHORT, null, blocking ? ToastBlockingPanel.class : ToastNoblockingPanel.class, null, null, null);
	}
	...
	public Object[] getBundleDescriptionParams() {
		return this.bundleDescriptionParams == null ? null : Arrays.copyOf(this.bundleDescriptionParams, this.bundleDescriptionParams.length);
	}
	...
	public Object[] getBundleMessageParams() {
		return this.bundleMessageParams == null ? null : Arrays.copyOf(this.bundleMessageParams, this.bundleMessageParams.length);
	}
