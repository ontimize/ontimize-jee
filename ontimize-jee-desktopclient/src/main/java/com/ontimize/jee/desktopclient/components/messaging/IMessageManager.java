...
public interface IMessageManager {
	...
	int showMessage(Component parent, String untranslatedMessage, MessageType messageType, Object args[], boolean blocking);
	...
	int showMessage(Component parent, String untranslatedMessage, String untranslatedDetail, MessageType messageType, Object args[]);

	int showMessage(Component parent, String untranslatedMessage, String untranslatedDetail, MessageType messageType, Object args[], boolean blocking);

	int showMessage(Component parent, String translatedMessage, String translatedDetail, MessageType messageType);

	int showMessage(Component parent, String translatedMessage, String translatedDetail, MessageType messageType, boolean blocking);
