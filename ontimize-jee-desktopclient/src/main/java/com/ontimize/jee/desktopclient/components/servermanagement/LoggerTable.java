...
public class LoggerTable extends Table {
	...
	public class LoggerExtendedTableModel extends ExtendedTableModel {
		...
		public LoggerExtendedTableModel(Hashtable<Object, Object> hashtable, Vector columns, Hashtable<Object, Object> hashtable2, boolean editable) {
			super(hashtable, columns, hashtable2, editable, new Vector());
		}

		@Override
		public Object getValueAt(int rowIndex, int columnIndex) {
			OntimizeJEELogger oJEELogger = (OntimizeJEELogger) super.getValueAt(rowIndex, this.getColumnIndex("OntimizeLogger"));
