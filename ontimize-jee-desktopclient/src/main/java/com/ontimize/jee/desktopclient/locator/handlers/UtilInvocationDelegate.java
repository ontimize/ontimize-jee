...
public class UtilInvocationDelegate extends AbstractInvocationDelegate implements UtilReferenceLocator {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.locator.UtilReferenceLocator#sendMessage(java.lang.String, java.lang.String, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.locator.UtilReferenceLocator#sendMessage(com.ontimize.locator.UtilReferenceLocator.Message, java.lang.String, int)
	 */
	@Override
