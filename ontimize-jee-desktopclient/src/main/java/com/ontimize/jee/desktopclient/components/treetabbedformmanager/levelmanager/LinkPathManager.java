...
public class LinkPathManager implements PathManager {
    ...
    public LinkPathManager() {
        this.init(new HashMap<Object, Object>());
    }
    ...
    private static void addLevel(Column column, List<Row> rows, final Level level, final LinkPathManager linkPathManager, String separator, boolean isLast, ResourceBundle resourceBundle) {
