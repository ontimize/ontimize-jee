...
public class DefaultLevelManager extends Column implements LevelManager {
	...
	public void init(Hashtable parameters) {
		...
		String defaultButtons = ConcatTools.concat(DefaultLevelManager.QUERY_BUTTON, '|', DefaultLevelManager.PREVIOUS_BUTTON, '|', DefaultLevelManager.HOME_BUTTON, '|',
		        DefaultLevelManager.REFRESH_BUTTON, '|', DefaultLevelManager.NEXT_BUTTON, '|', DefaultLevelManager.INSERT_BUTTON);
	...
	/**
	 * Creates the detail form for this table. The detail form is used to insert new records to the table and to diplay de information contained buy the table in a more detailed
	 * way using a form instead a row.
	 *
	 * @param iFormManager
	 */
