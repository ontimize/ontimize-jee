...
public class ToastBlockingPanel extends ToastNoblockingPanel implements ActionListener, Internationalization {
	...
	protected void init() {
		...
		this.add(this.buttonPanel, new GridBagConstraints(0, 2, 2, 1, 1, 0, GridBagConstraints.CENTER, GridBagConstraints.NONE, new Insets(2, 0, 3, 3), 0, 0));
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.utilmize.client.gui.toast.UToastNoblockingPanel#getResponse(com.utilmize.client.gui.toast.UToastMessage)
	 */
	@Override
