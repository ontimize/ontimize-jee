...
public class TreeTabbedFormManager extends BaseFormManager implements ITreeTabbedFormManager {
    ...
    /**
     * Creates a FormManager instance with the parameters establishes in <code>Hastable</code>. This constructor is called from {@link ApplicationBuilder}
     * <p>
     * The parameters <code>Hashtable<code> contains
     ...
     * <td></td>
     * <td>yes</td>
     * <td> Establishes the unique identifier for this <code>FormManager</code> </td> </tr>
     * <tr>
     * <td>useclasspath</td>
     * <td>yes/no</td>
     * <td>no</td>
     ...
     * <td></td>
     * <td>no</td>
     * <td>Established the <code>InteractionManager</code> that will be registered to initial <code>Form</code></td>
     * </tr>
     * <tr>
     * <td>imloader</td>
     * <td></td>
     ...
     * <td></td>
     * <td>no</td>
     * <td>Established the <code>ResourceBundle</code> that will be used in this <code>FormManager</code></td>
     * </tr>
     * <tr>
     * <td>dynamicform</td>
     * <td></td>
    ...
    public TreeTabbedFormManager(Frame frame, Container container, FormBuilder builder, String formURI, InteractionManager interactionManager, ResourceBundle resource, boolean northPanel) {
    ...
    private void createLayoutWithTree(Frame frame, Container container, FormBuilder builder, String formURI, InteractionManager interactionManager, ResourceBundle resources,
        ...
        try {
            ...
            if (com.ontimize.gui.ApplicationManager.DEBUG == true) {
                System.out.println(this.getClass().toString() + ": " + "Error adding form manager to the container. " + e.getMessage());
            }
            return;
        }
        ...
        if (Tree.PREFERRED_WIDTH == -1) {
            this.managedTreeTableColumn.getGUIComponent().setPreferredSize(new Dimension(treeTableColumn.getGUIComponent().getPreferredSize().width + 60, this.treeTableScrollPane.getPreferredSize().height));
        } else {
    ...
    public void setResourceBundle(ResourceBundle resources) {
        ...
        if (this.resourceFileName == null) {
            ...
            if (resources != null) {
                if ((this.delayedLoad == true) && !this.isLoaded()) {
    ...
    protected void finalize() throws Throwable {
		TreeTabbedFormManager.logger.debug("Finalized");
        super.finalize();
    }
     ...
     * as entry parameter. This method search this attribute into the <code>OTreeNode</code> and its parents.
     *
     * @param attribute
    ...
    protected Object getAttributeValue(Object attribute, OTreeNode node) {
        ...
        while (node.isRoot() == false) {
            if (node.isOrganizational() == false) {
     ...
     * established in method {@link #setActiveForm(Form)}. If the <code>Form</code> reference hasn't been established then this method
    ...
    public void dataChanged(DataNavigationEvent e) {
        if (this.processDataChangeEvents == false) {
            return;
        }
        Form f = e.getForm();
        if (f == null) {
        ...
        if (dfm != null) {
            ...
            if (fShowForm != null) {
                if (ApplicationManager.DEBUG == true) {
                    System.out.println("DataChanged: Form to show: " + fShowForm);
                }
                if (this.interactionManagerList.containsKey(fShowForm) == false) {
                ...
                if (this.formRegisteredDataNavigationListener.contains(fShowForm) == false) {
                ...
                if ((fNewForm != null) && (fNewForm != f)) {
                    if (ApplicationManager.DEBUG == true) {
                        System.out.println("Setting the form data list to show...");
                    }
                    ...
                    try {
                        ...
                        if (ApplicationManager.DEBUG == true) {
                            System.out.println("The form data list setted. Selected index: " + e.getIndex());
                        }
                    } catch (Exception ex) {
            ...
            System.out.println("DynamicFormManager is null for the form: " + f.getArchiveName());
        }
    }
    ...
    protected void registerApplicationPreferencesListener() {
        // if (this.preferenceListenersRegistered == false) {
    ...
    public boolean showFormInEDTh(String form) {
        ...
        if (this.checkVisiblePermission(form)) {
            if (this.loadedList.contains(form) == false) {
