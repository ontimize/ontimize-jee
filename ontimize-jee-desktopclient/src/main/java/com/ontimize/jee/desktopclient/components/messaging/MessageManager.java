...
public class MessageManager implements IMessageManager {
	 ...
	 * @param logger
	 *            the logger
	 * @param messageIfNullMessage
	 *            the message if null message
	 */
	@Override
	 ...
	 */
	@Override
	public int showMessage(Component parent, String untranslatedMessage, MessageType messageType, Object args[], boolean blocking) {
		String translatedMessage = this.translateMessage(parent, untranslatedMessage, args);
	 ...
	 */
	@Override
	public int showMessage(Component parent, String untranslatedMessage, String untranslatedDetail, MessageType messageType, Object args[]) {
		String translatedMessage = this.translateMessage(parent, untranslatedMessage, args);
	 ...
	 */
	@Override
	public int showMessage(Component parent, String untranslatedMessage, String untranslatedDetail, MessageType messageType, Object args[], boolean blocking) {
		String translatedMessage = this.translateMessage(parent, untranslatedMessage, args);
		String translatedDetail = this.translateMessage(parent, untranslatedDetail, args);
	...
	public int showMessage(Component parent, String translatedMessage, String translatedDetail, MessageType messageType) {
		return this.showMessage(parent, translatedMessage, translatedDetail, messageType, this.isMessageBlocking(messageType));
	}
	 ...
	 */
	@Override
	public int showMessage(Component parent, String translatedMessage, String translatedDetail, MessageType messageType, boolean blocking) {
		try {
	 ...
	 *            the translated message
	 * @param messageType
	 *            the type of message to be displayed: <code>ERROR_MESSAGE</code>, <code>INFORMATION_MESSAGE</code>, <code>WARNING_MESSAGE</code>, <code>QUESTION_MESSAGE</code>, or
	 *            <code>PLAIN_MESSAGE</code>
	 * @param detail
	 *            a <code>String</code> with more detailed information that can be shown in the <code>MessageDialog</code> to press a detail button. If detail parameter is null,
	 *            the detail button will not be shown
	 * @param bundle
	 *            the bundle
	...
	protected int oldMessageStyleInEDTh(Window w, String translatedMessage, MessageType messageType, String detail, ResourceBundle bundle) {
	...
	protected Object[] getMessageParameters(Throwable t) {
		return this.isParametrizedException(t) ? ((IParametrizedException) t).getMsgParameters() : null;
	}
	 ...
	 *
	 * @param translatedMesage
	 *            the translated mesage
	 * @param messageType
	 *            the message type
	 * @param parent
	 *            the parent
