...
public class WebsocketRemoteOperationManager implements RemoteOperationManager {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.util.operation.RemoteOperationManager#setRequired(java.lang .String, java.util.HashMap, int)
	 */
	@Deprecated
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.util.operation.RemoteOperationManager# getCurrentExecutionInformation(java.lang.String, int)
	 */
	@Deprecated
	@Override
