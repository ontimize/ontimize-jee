...
implements ActionListener, WorkerStatusUpdateListener, PropertyChangeListener, MouseListener, MouseMotionListener, FocusListener {
	 ...
	 *
	 * @param fxTime
	 *            Tiempo que durará el efecto en milisegundos
	 */
	 ...
	 *            the cancellable
	 */
	public void startShowRelativeTo(OSwingWorker<?, ?> worker, final RootPaneContainer container, boolean runWorker, boolean cancellable) {
		...
		if (((RootPaneContainer) BlockingProgressIndicator.this.currentContainer).getGlassPane() != BlockingProgressIndicator.this) {
			((RootPaneContainer) BlockingProgressIndicator.this.currentContainer).setGlassPane(BlockingProgressIndicator.this);
	...
	protected class HidePanelTimer extends Timer implements ActionListener {
		...
		public void stop() {
			...
			((RootPaneContainer) BlockingProgressIndicator.this.currentContainer).setGlassPane(BlockingProgressIndicator.this.previousGlassComponent);
