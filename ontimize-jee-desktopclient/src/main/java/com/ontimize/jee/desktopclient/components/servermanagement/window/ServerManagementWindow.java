...
public class ServerManagementWindow extends JFrame {
	...
	private JPanel getCardsPanel() {
		...
		// Create the "Live log console".
		JPanel setupLogLevelPanel = this.createPanel("ontimize-jee-forms/servermanagement/formSetupLogLevel.form", new IMSetupLogLevel());
		...
		// **Statistics**
		// Create the "Live log console".
		JPanel requestsPanel = this.createPanel("ontimize-jee-forms/servermanagement/formRequests.form", new IMRequest());
		// Create the "Live log console".
		...
		JPanel sqlManagerPanel = this.createPanel("ontimize-jee-forms/servermanagement/formSqlManager.form", new IMSqlManager());

		// **Server**
		// Create the "Sql manager".
		JPanel daosPanel = this.createPanel("ontimize-jee-forms/servermanagement/formDaosManager.form", new IMServerManager());
	...
	private SliderBar getSliderPanel() {
		...
		this.statisticsJList = this.createSlideBarSection(sliderBar, "Statistics", ServerManagementWindow.statisticsList, listener);
		this.dataBaseJList = this.createSlideBarSection(sliderBar, "Database", ServerManagementWindow.dataBaseList, listener);
		this.serverJList = this.createSlideBarSection(sliderBar, "Server management", ServerManagementWindow.serverList, listener);
		...
		public void valueChanged(final ListSelectionEvent e) {
			new Thread(new Runnable() {
				...
				private void checkPreviewSelections(String selectedValue) {
					...
					this.clearPreviewSelection(selectedValue, ServerManagementWindow.logList, ServerManagementWindow.this.logJList);
					this.clearPreviewSelection(selectedValue, ServerManagementWindow.dumpList, ServerManagementWindow.this.dumpJList);
					this.clearPreviewSelection(selectedValue, ServerManagementWindow.dataBaseList, ServerManagementWindow.this.dataBaseJList);
					this.clearPreviewSelection(selectedValue, ServerManagementWindow.statisticsList, ServerManagementWindow.this.statisticsJList);
					this.clearPreviewSelection(selectedValue, ServerManagementWindow.serverList, ServerManagementWindow.this.serverJList);
				}
