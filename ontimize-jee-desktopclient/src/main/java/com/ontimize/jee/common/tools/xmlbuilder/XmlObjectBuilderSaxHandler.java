...
/**
 * Handler que recibe los eventos de inicio/fin de an�lisis de elementos xml. En esta clase se realiza la construccion de los objetos declarados en el xml.
 *
 */
public class XmlObjectBuilderSaxHandler extends DefaultHandler {
	 ...
	 *            el Composite que hara de padre del Composite raiz definido en el xml.
	 * @param equivalences
	 *            el map de equivalencias.
	 */
	 ...
	 * @param parameters
	 *            los atributos del elemento en el xml
	 * @param parent
	 *            el objeto padre
	 * @return the object
	...
	protected void addToParent(final Object parent, final Object ob, final Map<String, String> parameters) {
		try {
			...
			throw new IllegalArgumentException("Can not add " + ob.getClass().getName() + " to " + parent.getClass().getName() + " because no add method found", e);
		}
