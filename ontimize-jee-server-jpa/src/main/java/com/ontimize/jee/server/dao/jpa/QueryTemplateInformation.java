...
public class QueryTemplateInformation {
     ...
     */
    public QueryTemplateInformation(final String sql, final Syntax syntax, final Class<?> resultClass,
     ...
     * @param resultClass the new result class
     */
     ...
     * @param mappingInfo the new mapping info
     */
     ...
     * @param ambiguousColumns the new ambiguous columns
     */
     ...
     * @param functionColumns the new function columns
     */
