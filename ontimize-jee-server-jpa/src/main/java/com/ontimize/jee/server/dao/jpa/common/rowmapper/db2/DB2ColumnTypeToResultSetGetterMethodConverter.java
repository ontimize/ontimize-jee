...
public class DB2ColumnTypeToResultSetGetterMethodConverter implements IColumnTypeToResultSetGetterMethodConverter {
    ...
    private static final Map<String, String> columnTypeToGetter;

    static {
        columnTypeToGetter = new HashMap<>();
        DB2ColumnTypeToResultSetGetterMethodConverter.columnTypeToGetter
            .put(DB2ColumnTypeToResultSetGetterMethodConverter.STRING_TYPE, "getString");
        DB2ColumnTypeToResultSetGetterMethodConverter.columnTypeToGetter
            .put(DB2ColumnTypeToResultSetGetterMethodConverter.CLOB_TYPE, "getClob");
        DB2ColumnTypeToResultSetGetterMethodConverter.columnTypeToGetter
            .put(DB2ColumnTypeToResultSetGetterMethodConverter.DATE_TYPE, "getDate");
        DB2ColumnTypeToResultSetGetterMethodConverter.columnTypeToGetter
            .put(DB2ColumnTypeToResultSetGetterMethodConverter.TIME_TYPE, "getTime");
        DB2ColumnTypeToResultSetGetterMethodConverter.columnTypeToGetter
            .put(DB2ColumnTypeToResultSetGetterMethodConverter.TIMESTAMP_TYPE, "getTimestamp");
    }
