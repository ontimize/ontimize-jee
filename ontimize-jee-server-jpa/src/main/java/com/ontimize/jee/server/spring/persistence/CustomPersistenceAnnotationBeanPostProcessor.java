...
public class CustomPersistenceAnnotationBeanPostProcessor extends PersistenceAnnotationBeanPostProcessor {
    ...
    private List<String> beansToProcess = new ArrayList<String>();
     ...
     * of no unit name specified in an {@code @PersistenceUnit} / {@code @PersistenceContext} annotation.
     * <p>
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessMergedBeanDefinition(org.springframework.beans.factory.support.RootBeanDefinition, java.lang.Class, java.lang.String)
     */
    @Override
    public void postProcessMergedBeanDefinition(final RootBeanDefinition beanDefinition, final Class<?> beanType, final String beanName) {
        if ((beanType != null) && procesable(beanName)) {
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessPropertyValues(org.springframework.beans.PropertyValues, java.beans.PropertyDescriptor[], java.lang.Object, java.lang.String)
     */
    @Override
    public PropertyValues postProcessPropertyValues(
            final PropertyValues pvs, final PropertyDescriptor[] pds, final Object bean, final String beanName) throws BeansException {
        PropertyValues pvsLocal = pvs;
        if (procesable(beanName)) {
