...
public class CustomPersistenceAnnotationBeanPostProcessor extends PersistenceAnnotationBeanPostProcessor {
     ...
     * <p>
     * This is mainly intended for lookups in the application context, indicating the target persistence
     * unit name (typically matching the bean name), but also applies to lookups in the
     ...
     * <p>
     * Default is to check for a single EntityManagerFactory bean in the Spring application context, if
     * any. If there are multiple such factories, either specify this default persistence unit name or
     * explicitly refer to named persistence units in your annotations.
     */
    @Override
     ...
     * @param beansToProcess the new beans to process
     */
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessBeforeInstantiation(java.lang.Class,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessAfterInstantiation(java.lang.Object,
     *      java.lang.String)
     */
    @Override
     ...
     */
    @Override
    public PropertyValues postProcessPropertyValues(final PropertyValues pvs, final PropertyDescriptor[] pds,
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessBeforeInitialization(java.lang.Object,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessAfterInitialization(java.lang.Object,
     *      java.lang.String)
     */
    @Override
    ...
    /**
     * @see org.springframework.orm.jpa.support.PersistenceAnnotationBeanPostProcessor#postProcessBeforeDestruction(java.lang.Object,
     *      java.lang.String)
     */
    @Override
    ...
    @Override
    protected EntityManagerFactory findEntityManagerFactory(final String unitName, final String requestingBeanName)
