...
public final class JPAUtils {
	 ...
	 * @throws Exception
	 */
	// public static Hashtable<Object, Object> getAutoconfigureColumns(final String entityClass, final String queryEntityClass, final DefaultParametersJpa.LevelsAutoconfigure
	...
	/**
	 * Added to <code>columns</code> the Strings in field "Columns" of <code>embeddColums</code> preceded by " <code>fieldName.</code>". The same to <code>insertColumns</code> and
	...
	/**
	 * This method is called to "Hashtable<Object, Object> getAutoconfigureColumns(String entityClass)" to get the names of attributes of beans related with @ManyToOne or
	 * [@OneToOne with @JoinColum].
	 *
	 * @param relatedBean
	...
	/**
	 * Get the fields of relatedBean which represent the database columns equals of 'referencedColumnName' of JoinColum annotation "annota".
	 *
	 * @param relatedBean
	 * @param annota
	 *            JoinColumn or JoinColumns annotation
	 * @return Get the fields of relatedBean which represent the database columns equals of 'referencedColumnName' of JoinColum annotation "annota".
	 * @throws Exception
	 */
	...
	/**
	 * Get the name of columns, insertColumns, updateColumn using the JPA annotations of beans. This method is used when entity have two different beans.
	 *
	 * @param entityClass
	 *            The EntityBean of some Entity.
	 * @param queryEntityClass
