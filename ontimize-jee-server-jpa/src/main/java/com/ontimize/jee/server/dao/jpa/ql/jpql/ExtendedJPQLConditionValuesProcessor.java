...
public class ExtendedJPQLConditionValuesProcessor extends DefaultJPQLConditionValuesProcessor {
    ...
    /**
     * Creates a <code>ExtendedSQLConditionValuesProcessor</code> where
     * every condition that uses <code>LIKE</code> is case-insensitive.
     * <p>
    ...
    /**
     * Creates a <code>ExtendedSQLConditionValuesProcessor</code> where
     * every condition that uses <code>LIKE</code> or is a column of String
     * type is case-insensitive.
     * <p>
     * Inserts a upper function in both sides of <code>LIKE</code> conditions (UPPER(Field) LIKE UPPER(Value)) Inserts a
     * upper function in both sides if column type is a String (UPPER(Field) LIKE UPPER(String))
     *
     * @param upperStrings
     ...
     * @param values
     *            a list where the required values for the condition are
     *            stored
     * @return a <code>String</code> where is stored a condition in text
     *         format
     */
    ...
    /**
     * Creates the condition string from a expression. The condition string
     * is stored in the <code>StringBuffer</code> param and the required
     * values in a <code>Vector</code> param
     *
     * @param expression
     *            a class that implements <code>Expression<code> interface
     * @param values
     ...
     *            stored
     * @param sb
     *            a <code>StringBuffer</code> where the condition string is
     *            stored
     */
     ...
     * @param values
     *            vector where the value of each processed conditions is
     *            stored
     * @return
     */
    ...
    public String createQueryConditions(final Map<?, ?> conditions, final List<String> wildcards) {
        ...
        if (conditions.containsKey(ExtendedSQLConditionValuesProcessor.EXPRESSION_KEY)
