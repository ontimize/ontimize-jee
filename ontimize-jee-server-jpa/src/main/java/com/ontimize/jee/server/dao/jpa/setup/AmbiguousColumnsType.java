 ...
 *       &lt;sequence>
 *         &lt;element name="AmbiguousColumn" type="{http://jpaentity.server.jee.imatia.com/setup}AmbiguousColumnType" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlType(name = "AmbiguousColumnsType", propOrder = {
    "ambiguousColumn"
})
public class AmbiguousColumnsType {
     ...
     * This is why there is not a <CODE>set</CODE> method for the ambiguousColumn property.
     * 
     * <p>
     ...
     * {@link AmbiguousColumnType }
     * 
     * 
     */
    public List<AmbiguousColumnType> getAmbiguousColumn() {
        if (ambiguousColumn == null) {
            ambiguousColumn = new ArrayList<AmbiguousColumnType>();
        }
