...
public class CassandraQueryTemplateInformation {
     ...
     */
    public CassandraQueryTemplateInformation(String cql, List<AmbiguousColumnType> ambiguousColumns,
            List<FunctionColumnType> functionColumns, List<String> validColumns) {
        this();
     ...
     * @param ambiguousColumns the ambiguousColumns to set
     */
