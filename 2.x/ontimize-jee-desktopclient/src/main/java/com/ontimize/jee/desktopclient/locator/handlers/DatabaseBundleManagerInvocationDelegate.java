 ...
 */
public class DatabaseBundleManagerInvocationDelegate extends AbstractInvocationDelegate implements IDatabaseBundleManager {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.gui.i18n.IDatabaseBundleManager#getBundle(java.lang.String, java.util.Locale, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.gui.i18n.IDatabaseBundleManager#getBundles(java.util.List, java.util.Locale, int)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.gui.i18n.IDatabaseBundleManager#updateBundleValues(com.ontimize.gui.i18n.DatabaseBundleValues, int)
	 */
	@Override
