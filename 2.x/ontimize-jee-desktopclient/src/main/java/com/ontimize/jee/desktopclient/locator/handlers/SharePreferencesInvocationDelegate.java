...
public class SharePreferencesInvocationDelegate extends AbstractInvocationDelegate implements IShareRemoteReference {
	...
	@Override
	public EntityResult addSharedItem(SharedElement sharedObject, List<String> targetList, int sessionId) throws Exception {
	...
	@Override
	public List<SharedElement> getSharedItemsWithUserAndKey(String username, String shareKey, int sessionId) throws Exception {
		return this.getSharePreferencesService().getSharedItemsWithUserAndKey(username, shareKey);
	}

	@Override
	public List<HashMap<String, Object>> getTargetSharedElementMenuList(String username, String shareKey, int sessionId) throws Exception {
	...
	@Override
	public List<SharedElement> getSourceSharedItemsList(String username, String shareKey, int sessionId) throws Exception {
		return this.getSharePreferencesService().getSourceSharedItemsList(username, shareKey);
	}

	@Override
	public List<HashMap<String, Object>> getSourceSharedElementMenuList(String username, String shareKey, int sessionId) throws Exception {
	...
	@Override
	public EntityResult updateSharedItem(int idShare, String content, String message, String name, int sessionId) throws Exception {
		return this.getSharePreferencesService().updateSharedItem(idShare, content, message, name);
	}

	@Override
	public EntityResult addSharedItem(SharedElement sharedObject, List<String> targetList, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().addSharedItem(sharedObject, targetList);
	}

	@Override
	public EntityResult editTargetSharedElement(int idShare, List<String> targetList, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().editTargetSharedElement(idShare, targetList);
	}
	...
	@Override
	public List<SharedElement> getSharedItemsWithUserAndKey(String username, String shareKey, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().getSharedItemsWithUserAndKey(username, shareKey);
	}

	@Override
	public List<HashMap<String, Object>> getTargetSharedElementMenuList(String username, String shareKey, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().getTargetSharedElementMenuList(username, shareKey);
	}
	...
	@Override
	public List<SharedElement> getSourceSharedItemsList(String username, String shareKey, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().getSourceSharedItemsList(username, shareKey);
	}

	@Override
	public List<HashMap<String, Object>> getSourceSharedElementMenuList(String username, String shareKey, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().getSourceSharedElementMenuList(username, shareKey);
	}
	...
	@Override
	public EntityResult updateSharedItem(int idShare, String content, String message, String name, int sessionId, Connection con) throws Exception {
		return this.getSharePreferencesService().updateSharedItem(idShare, content, message, name);
	}
