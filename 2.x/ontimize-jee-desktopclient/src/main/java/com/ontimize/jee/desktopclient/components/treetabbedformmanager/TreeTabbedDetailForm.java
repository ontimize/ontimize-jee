	...
	public void updateTitle() {
		...
		if (index > 0) {
			...
			if (InteractionManager.INSERT == currentMode) {
				descriptionText = ApplicationManager.getTranslation(this.level.getEntityName(), this.form.getResourceBundle()) + "(" + ApplicationManager.getTranslation("insert",
				        this.form.getResourceBundle()) + ")";
			} else if (InteractionManager.QUERY == currentMode) {
				descriptionText = ApplicationManager.getTranslation(this.level.getEntityName(), this.form.getResourceBundle()) + "(" + ApplicationManager.getTranslation("query",
				        this.form.getResourceBundle()) + ")";
			} else {
