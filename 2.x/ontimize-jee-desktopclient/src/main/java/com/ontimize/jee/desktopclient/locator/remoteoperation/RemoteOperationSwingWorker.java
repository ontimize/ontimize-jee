...
public class RemoteOperationSwingWorker<T, V> extends OSwingWorker<T, V> {
	...
	protected class RemoteOperationListener<U> implements IRemoteOperationListener<U> {
		 ...
		 * (non-Javadoc)
		 * @see
		 * com.ontimize.jee.desktopclient.locator.remoteoperation.IRemoteOperationListener#onStatusUpdated(com.ontimize.jee.common.services.remoteoperation
		 * .RemoteOperationStatusMessage)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ontimize.jee.desktopclient.locator.remoteoperation.IRemoteOperationListener#onError(java.lang.Throwable)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.ontimize.jee.desktopclient.locator.remoteoperation.IRemoteOperationListener#onFinish(com.ontimize.jee.common.services.remoteoperation.
		 * RemoteOperationFinishMessage)
		 */
		@Override
