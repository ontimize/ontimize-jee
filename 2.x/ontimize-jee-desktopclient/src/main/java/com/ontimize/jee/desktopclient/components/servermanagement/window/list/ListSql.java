...
public class ListSql extends JScrollPane implements DataComponent, AccessForm, ValueChangeDataComponent {
	...
	public void deleteData() {
		if (this.list.getModel() instanceof DefaultListModel) {
			...
			ListSql.logger.error("UList: The delete method is not available to this model list: {}", this.list.getModel().getClass().getName());
		}
	}
	...
	public Object getConstraints(LayoutManager layoutmanager) {
		if (layoutmanager instanceof GridBagLayout) {
			return new GridBagConstraints(-1, -1, 1, 1, 1.0d, 1.0d, GridBagConstraints.CENTER, GridBagConstraints.BOTH, new Insets(0, 0, 0, 0), 0, 0);
		}
		return null;
	}
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.gui.ValueChangeDataComponent#addValueChangeListener(com.ontimize.gui.ValueChangeListener)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.gui.ValueChangeDataComponent#removeValueChangeListener(com.ontimize.gui.ValueChangeListener)
	 */
	@Override
