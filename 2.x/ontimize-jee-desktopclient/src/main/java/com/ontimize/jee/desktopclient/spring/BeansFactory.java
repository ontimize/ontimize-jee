...
/**
 * Clase de ayuda para acceder a beans de spring. Debe iniciarse BeansFactory.init en el lanzador del cliente.
 *
 */
public final class BeansFactory {
	 ...
	 *
	 * @param springConfigurationFile
	 *            ficheros de configuración para iniciar el contexto. En caso de ser null se utiliza DEFAULT_SPRING_CONFIG_FILE
	 */
	public static void init(String[] springConfigurationFile) {
		if (BeansFactory.applicationContext == null) {
			...
			BeansFactory.applicationContext = new GenericXmlApplicationContext(contextFiles.toArray(new String[contextFiles.size()]));
		}
	}
