...
public abstract class AbstractOntimizeTest {
	...
	public static class TestLoginProvider implements ILoginProvider {
		...
		/*
		 * (non-Javadoc)
		 * @see com.ontimize.jee.common.security.ILoginProvider#doLogin(java.net.URI, java.lang.String, java.lang.String)
		 */
		@Override
		public void doLogin(URI serviceUrl, String user, String password) throws InvalidCredentialsException {
			...
			try {
				// no pedemos autenticar con un servicio hessian porque la entity (inputstream) no es "repeatable" y no puede llevar a cabo la
				// negociacion
