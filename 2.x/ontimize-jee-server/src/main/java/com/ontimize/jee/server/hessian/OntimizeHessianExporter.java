 ...
 *
 * <p><b>Note:</b> Spring also provides an alternative version of this exporter, for Sun's JRE 1.6 HTTP server: {@link SimpleHessianServiceExporter}.
 *
 * <p>Hessian is a slim, binary RPC protocol. For information on Hessian, see the <a href="http://www.caucho.com/hessian">Hessian website</a>. <b>Note: As of Spring 4.0, this
 * exporter requires Hessian 4.0 or above.</b>
 *
 * <p>Hessian services exported with this class can be accessed by any Hessian client, as there isn't any special handling involved.
 *
...
public class OntimizeHessianExporter extends RemoteExporter implements InitializingBean, HttpRequestHandler {
	...
	public void prepare() {
		...
		this.skeleton = new HessianSkeleton(this.getProxyForService(), this.getServiceInterface(), this.getExceptionTranslator());
	}
