...
public class SharePreferencesEngine implements ISharePreferencesService, InitializingBean {
	...
	@Autowired private ISecurityUserInformationService userService;
	 ...
	 *
	 * @param shareKeyColumn
	 *            {@link String} the shared preferences key column.
	 */
	 ...
	 *
	 * @param shareTargetKeyColumn
	 *            {@link String} the shared preference target key column
	 */
	 ...
	 *
	 * @param shareUserColumn
	 *            {@link String} the shared preferences user column
	 */
	 ...
	 *
	 * @param shareTypeColumn
	 *            {@link String} the shared preferences type column
	 */
	 ...
	 *
	 * @param shareContentColumn
	 *            {@link String} the shared preferences content column
	 */
	 ...
	 *
	 * @param shareMessageColumn
	 *            {@link String} the shared preferences message column
	 */
	 ...
	 *
	 * @param shareNameColumn
	 *            {@link String} the share preference name column
	 */
	 ...
	 *
	 * @param daoSharePref
	 *            {@link IOntimizeDaoSupport} The DAO for shared preferences
	 */
	 ...
	 *
	 * @param daoSharePref
	 *            {@link IOntimizeDaoSupport} The DAO for shared preference
	 *            targets
	 */
	...
	public void afterPropertiesSet() throws Exception {
		CheckingTools.failIfEmptyString(this.shareKeyColumn, "The identifier column does not exist in the database for the share preferences table");
		CheckingTools.failIfEmptyString(this.shareTargetKeyColumn, "The target column key does not exist in the database for the share preferences target table");
		CheckingTools.failIfEmptyString(this.shareUserColumn, "The user column key does not exist in the database for the share preferences table");
		CheckingTools.failIfEmptyString(this.shareTargetUserColumn, "The target user column key does not exist in the database for the share target preferences table");
		CheckingTools.failIfEmptyString(this.shareTypeColumn, "The type column key does not exist in the database for the share preferences table");
		CheckingTools.failIfEmptyString(this.shareContentColumn, "The content column key does not exist in the database for the share preferences table");
		CheckingTools.failIfEmptyString(this.shareMessageColumn, "The message column key does not exist in the database for the share preferences table");
		CheckingTools.failIfEmptyString(this.shareNameColumn, "The name column key does not exist in the database for the share preferences table");
	...
	/**
	 * Method used for reduce the complexity of
	 * {@link #editTargetSharedElement(int, List)}
	 *
	 * @param shareResult
	 *            {@link EntityResult}
	 * @param sharedElementKey
	 *            {@link Map}
	 * @param targetList
	 *            {@link List}
	 ...
	 */
	protected void editTargetUsers(EntityResult shareResult, Map<String, Object> sharedElementKey, List<String> targetList) throws OntimizeJEEException {

		String userSessionName = ((UserInformation) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getLogin();
		...
		if (userSessionName.equalsIgnoreCase((String) shareResult.getRecordValues(0).get(this.getShareUserColumn()))) {
			...
			EntityResult erTarget = this.daoHelper.query(this.daoSharePrefTarget, sharedElementKey, attributeTargetList);
			...
			if (erTarget.getCode() != EntityResult.OPERATION_WRONG) {
				...
				List<String> existingTargets = ((List<String>) erTarget.get(this.getShareTargetUserColumn()) == null) ? new ArrayList<String>()
	...
	/**
	 * Method used for reduce the complexity of
	 * {@link #editTargetUsers(EntityResult, Map, List)}
	 *
	 * @param targetNameToDelete
	 *            {@link List}
	 * @param erTarget
	 *            {@link EntityResult}
	 * @throws OntimizeJEEException
	 ...
	 * @see {@link #editTargetSharedElement(int, List)}
	 */
	protected void deleteTargetUsers(List<String> targetNameToDelete, EntityResult erTarget) throws OntimizeJEEException {
	 ...
	 * @see {@link #editTargetSharedElement(int, List)}
	 */
	protected void addTargetUsers(List<String> targetToAdd, Map<String, Object> sharedElementKey) throws OntimizeJEEException {
	...
	public List<SharedElement> getSharedItemsWithUserAndKey(String username, String shareKey) throws OntimizeJEEException {
		...
		EntityResult eRToRetTarget = this.daoHelper.query(this.daoSharePrefTarget, keysSharedElementValues, attributesSharedElement);
	...
	public List<HashMap<String, Object>> getTargetSharedElementMenuList(String username, String shareKey) throws OntimizeJEEException {
		...
		EntityResult erTargetList = this.daoHelper.query(this.daoSharePrefTarget, keysSharedElementValues, attributesSharedElementTarget);
	...
	public SharedElement getSharedItem(int idShare) throws OntimizeJEEException {
		...
		EntityResult eRToRet = this.daoHelper.query(this.daoSharePref, keysSharedElementValues, attributesSharedElement);
	...
	/**
	 * Method used for reduce the complexity of
	 * {@link #deleteTargetSharedItem(int)}
	 *
	 ...
	 */
	protected void deleteTargetSharedItem(Map<String, Object> targetQueryKeys, Object shareTarget, EntityResult sharedItem) throws OntimizeJEEException {
		// Check if user is the owner or the target
		Object shareItemOwner = sharedItem.getRecordValues(0).get(this.getShareUserColumn());
		String userSessionName = ((UserInformation) SecurityContextHolder.getContext().getAuthentication().getPrincipal()).getLogin();
		if (userSessionName.equalsIgnoreCase((String) shareItemOwner) || userSessionName.equalsIgnoreCase((String) shareTarget)) {
			// Delete target
