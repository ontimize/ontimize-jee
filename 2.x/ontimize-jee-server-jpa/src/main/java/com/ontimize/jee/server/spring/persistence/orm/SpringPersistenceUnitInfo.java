...
/**
 * Subclass of {@link MutablePersistenceUnitInfo} that adds instrumentation hooks based on Spring's {@link org.springframework.instrument.classloading.LoadTimeWeaver} abstraction.
 *
...
class SpringPersistenceUnitInfo extends MutablePersistenceUnitInfo {
	 ...
	 *
	 * @param b
	 *            the new transaction type setted
	 */
	 ...
	 *
	 * @param b
	 *            the new jta data source setted
	 */
	 ...
	 *
	 * @param b
	 *            the new non jta data source setted
	 */
	 ...
	 *
	 * @param b
	 *            the new persistence provider class name setted
	 */
	 ...
	 *
	 * @param b
	 *            the new exclude unlisted classes setted
	 */
	 ...
	 *
	 * @param b
	 *            the new shared cache mode setted
	 */
	 ...
	 *
	 * @param b
	 *            the new validation mode setted
	 */
