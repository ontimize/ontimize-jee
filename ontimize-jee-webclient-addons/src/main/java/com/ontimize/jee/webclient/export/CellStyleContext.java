...
/**
 * Contexto que se envía al usuario para que pueda decidir qué estilo tiene una celda. Lleva información de la celda y su valor y también un
 * creador de estilos excel y otro de formatos.
 *
...
public class CellStyleContext<T, D> {
  ...
  public CellStyleContext(
      final int row, final int colUserIndex, final String columnId, final Object cellValue, final T cellStyle,
