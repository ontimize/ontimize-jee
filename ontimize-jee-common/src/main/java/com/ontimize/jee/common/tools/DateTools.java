...
public final class DateTools {
	...
	public static final long	MILLLISECONDS_PER_MINUTE	= DateTools.SECONDS_PER_MINUTE * DateTools.MILLISECONDS_PER_SECOND;
	 ...
	 * @param end
	 *            the end
	 * @param exceptweekends
	 *            the exceptweekends
	 * @param except
	 *            days to exclude. It can be null.
	 * @return the long[]
	 */
