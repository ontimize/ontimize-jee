...
public final class CheckingTools {
    ...
    public static void failIfNull(Object toCheck, String messageFormat, Object... messageParameters) {
        if (toCheck == null) {
            throw new OntimizeJEERuntimeException((messageParameters == null) || (messageParameters.length == 0)
    ...
    public static <T extends Throwable> void failIf(boolean toCheck, Class<T> exceptionClass, String messageFormat,
        ...
        if (toCheck) {
            String message = (messageParameters == null) || (messageParameters.length == 0) ? messageFormat
                    : String.format(messageFormat, messageParameters);
     ...
     * @throws Exception Cuando o es reaultado NULL o no es correcto.
     */
    public static void checkValidEntityResult(EntityResult res, String messageFormat, boolean checkSomeRecordRequired,
            boolean checkOnlyOneRecord, Object... messageParameters)
            throws OntimizeJEEException {
