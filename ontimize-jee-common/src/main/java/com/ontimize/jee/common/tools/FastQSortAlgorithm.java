...
public class FastQSortAlgorithm {
    ...
    public static void main(String[] args) {
        try {
            Integer[] aa = new Integer[] { 3, 24, 542, 1234, 56346, 642, 3414, 5436, 473, 2412, 4121, 41234, 54, 67, 4,
                    87676, 674646, 346, 342423, 42154, 36, 54, 34643, 64 };
            String[] a = new String[] { "hola", "adios", "caracola", "flor", null, "traza", "identificador",
                    "marcador" };
