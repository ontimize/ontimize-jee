...
public class LocaleSerializerFactory extends AbstractSerializerFactory {
	...
	public static class LocaleDeserializer extends AbstractDeserializer {
		...
		/*
		 * (non-Javadoc)
		 * @see com.caucho.hessian.io.AbstractDeserializer#readMap(com.caucho.hessian.io.AbstractHessianInput)
		 */
		@Override
		...
		/*
		 * (non-Javadoc)
		 * @see com.caucho.hessian.io.AbstractDeserializer#readObject(com.caucho.hessian.io.AbstractHessianInput, java.lang.Object[])
		 */
		@Override
	...
	public class LocaleSerializer extends AbstractSerializer {
		...
		/*
		 * (non-Javadoc)
		 * @see com.caucho.hessian.io.AbstractSerializer#writeObject(java.lang.Object, com.caucho.hessian.io.AbstractHessianOutput)
		 */
		@Override
