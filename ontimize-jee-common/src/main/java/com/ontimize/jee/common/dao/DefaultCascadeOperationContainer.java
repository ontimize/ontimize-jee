...
public class DefaultCascadeOperationContainer implements ICascadeOperationContainer, Serializable {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.cascadeoperation.ICascadeOperationAttribute#getDeleteOperations()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.cascadeoperation.ICascadeOperationAttribute#getInsertOperations()
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.cascadeoperation.ICascadeOperationAttribute#getUpdateOperations()
	 */
	@Override
	...
	public boolean hasOperations() {
		return (this.getInsertOperations().size() > 0) || (this.getUpdateOperations().size() > 0) || (this.getDeleteOperations().size() > 0);
	}
