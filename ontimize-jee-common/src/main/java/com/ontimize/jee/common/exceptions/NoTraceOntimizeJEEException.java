...
public class NoTraceOntimizeJEEException extends OntimizeJEEException {
    ...
    private static Object[] getMessageParams(Throwable cause) {
        if ((cause instanceof IParametrizedException)
                && (((IParametrizedException) cause).getMessageParameters() != null)) {
     ...
     * @param msgParameters the msg parameters
     */
    public NoTraceOntimizeJEEException(String message, Throwable cause, Object[] msgParameters, MessageType type,
            boolean msgBocking, boolean silent) {
     ...
     */
    public NoTraceOntimizeJEEException(String message, Throwable cause, Object[] msgParameters, MessageType type,
            boolean msgBocking, boolean silent, boolean enableSuppression,
    ...
    public NoTraceOntimizeJEEException(OntimizeJEERuntimeException cause) {
        this(cause.getMessage(), null, cause.getMessageParameters(), cause.getMessageType(), cause.isMessageBlocking(),
                cause.isSilent());
    }
