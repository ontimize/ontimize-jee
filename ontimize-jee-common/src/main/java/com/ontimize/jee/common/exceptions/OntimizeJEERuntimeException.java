...
public class OntimizeJEERuntimeException extends RuntimeException implements IParametrizedException {
     ...
     * @param cause the cause
     */
    public OntimizeJEERuntimeException(String message, Object[] msgParameters, Throwable cause, boolean msgBlocking,
            boolean silent) {
     ...
     */
    public OntimizeJEERuntimeException(String message, Object[] msgParameters, MessageType msgType,
            boolean msgBlocking) {
     ...
     */
    public OntimizeJEERuntimeException(String message, Object[] msgParameters, Throwable cause, MessageType msgType,
     ...
     */
    public OntimizeJEERuntimeException(String message, Throwable cause, Object[] msgParameters, MessageType msgType,
     ...
     * @param writableStackTrace the writable stack trace
     */
    public OntimizeJEERuntimeException(String message, Throwable cause, MessageType msgType, boolean msgBlocking,
            boolean silent, boolean enableSuppression,
            boolean writableStackTrace) {
