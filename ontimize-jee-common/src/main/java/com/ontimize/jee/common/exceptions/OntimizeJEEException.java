...
public class OntimizeJEEException extends Exception implements IParametrizedException {
     ...
     */
    public OntimizeJEEException(String message, Object[] msgParameters, Throwable cause, MessageType msgType,
     ...
     */
    public OntimizeJEEException(String message, Throwable cause, Object[] msgParameters, MessageType msgType,
     ...
     * @param writableStackTrace the writable stack trace
     */
    public OntimizeJEEException(String message, Throwable cause, MessageType msgType, boolean msgBlocking,
