...
class OracleSQLStatementHandlerTest {
    ...
    class CreateSelectQuery {
        ...
        void when_receive_one_table_expect_select_query() {
            ...
            var result = oracleSQLStatementHandler.createSelectQuery(table, null, null, null);
    ...
    class AddOuterMultilanguageColumnsPageable {
        ...
        void when_receive_sqlQuery_and_table_and_hLocaleTablesAV_expect_add_outer_multilanguage_columns_pageable() {
            ...
            var result = oracleSQLStatementHandler.addOuterMultilanguageColumnsPageable(sqlQuery, table, hLocaleTablesAV);
    ...
    class ConvertPaginationStatement{
        ...
        void when_receive_sqlTemplate_and_starIndex_and_recordNumber_expected_convert_pagination_statement(){
            ...
            var result = oracleSQLStatementHandler.convertPaginationStatement(sqlTemplate,starIndex,recordNumber);
            var expected= "SELECT * FROM (sqlTemplate) WHERE ROWNUM<= 1";
