...
public interface IOntimizeDaoHelper {
    ...
    /**
     * @param kv a <code>Map<Object,Object></code> specifying conditions that must comply the set of
     ...
     * @param orderBy a <code>List<Object></code> of String or {@link SQLStatementBuilder.SQLOrder}
     *        objects in where the column orderer is established.
     * @return
     * @throws Exception
     */
    AdvancedEntityResult paginationQuery(IOntimizeDaoSupport repository, Map<?, ?> kv, List<?> attributes,
            int recordNumber, int startIndex, List<?> orderBy, String queryId)
     ...
     * <p>
     * @param repository DAO repository to look for.
     * @param keysValues a Map<Object,Object> specifying conditions that must comply the set of records
     ...
     * @param queryId Query identifier to use under DAO repository.
     ...
     */
    EntityResult query(IOntimizeDaoSupport repository, Map<?, ?> keysValues, List<?> attributes, String queryId)
            throws OntimizeJEERuntimeException;
     ...
     * @param attributes a list of columns or attributes that must be recovered for each record
     *        returned. Cannot be null. If empty, all attributes should be returned.
     * @param attributes a list of columns to sort result. Can be null. If empty, no sort applyed.
     * @param queryId Query identifier to use under DAO repository.
     * @return a EntityResult with the resulting set of data. This result can be empty if no results
     *         exist, and if an error has ocurred this will be indicated in the result.
     * @throws Exception if any exception occurs
     ...
     * @param <T> the generic type of bean to be adquired
     * @param repository the repository to be queried
     * @param keysValues the keys values to filter
     * @param sort the sort
     * @param queryId the query id to use
     * @param clazz the clazz
     * @return the list
     */
    <T> List<T> query(IOntimizeDaoSupport repository, Map<?, ?> keysValues, List<?> sort, String queryId,
            Class<T> clazz);
     ...
     * <p>
     * @param attributesValues a Map<Object,Object> specifying pairs of key-value corresponding to the
     ...
     * @throws Exception if any exception occurs
     */
    EntityResult update(IOntimizeDaoSupport repository, Map<?, ?> attributesValues, Map<?, ?> keysValues)
            throws OntimizeJEERuntimeException;
