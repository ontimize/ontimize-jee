...
public class SharePreferencesServiceImpl implements ISharePreferencesService, ApplicationContextAware {
    ...
    /**
     * Sets the engine
     * @param engine {@link ISharePreferencesService} the engine
     */
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        this.setEngine(
                applicationContext.getBean(OntimizeConfiguration.class).getSharePreferencesConfiguration().getEngine());
    }
