...
public class SpringMailConfigurator implements IMailConfigurator {
     ...
     * (non-Javadoc)
     *
     * @see com.ontimize.jee.server.services.mail.IMailConfigurator#configure(com.ontimize.jee.server.
     * services.mail.IMailEngine)
     */
    @Override
    public void configure(IMailEngine engine) {
        CheckingTools.failIf(!(engine instanceof SpringMailEngine), "Engine is not instanceof %s",
                SpringMailEngine.class.getName());
     ...
     * @param encodingResolver the encodingResolver to set
     */
     ...
     * @param hostResolver the hostResolver to set
     */
     ...
     * @param protocolResolver the protocolResolver to set
     */
     ...
     * @param passwordResolver the passwordResolver to set
     */
