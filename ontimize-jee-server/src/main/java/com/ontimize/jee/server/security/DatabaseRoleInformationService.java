...
public class DatabaseRoleInformationService implements ISecurityRoleInformationService {
    ...
    public Role loadRole(String roleName) {
        ...
        final List<String> columnsToQuery = Arrays
            .asList(new String[] { this.roleNameColumn, this.clientPermissionColumn });
        final EntityResult res = this.profileRepository.query(filter, columnsToQuery, null,
                this.clientPermissionQueryId);
    ...
    protected List<String> loadServerPermissions(final String roleName) {
        ...
        filter.put(this.roleNameColumn, roleName);
        final List<String> columnsToQuery = Arrays
            .asList(new String[] { this.roleNameColumn, this.serverPermissionKeyColumn });
        final EntityResult res = this.profileRepository.query(filter, columnsToQuery, null,
                this.serverPermissionQueryId);
    ...
    /**
     * @param serverPermissionKeyColumn the serverPermissionKeyColumn to set
     */
    ...
    /**
     * @param clientPermissionColumn the clientPermissionColumn to set
     */
    ...
    /**
     * @param serverPermissionQueryId the serverPermissionQueryId to set
     */
    ...
    /**
     * @param clientPermissionQueryId the clientPermissionQueryId to set
     */
