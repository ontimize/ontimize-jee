...
public class DatabaseUserRoleInformationService implements ISecurityUserRoleInformationService {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.server.security.ISecurityUserRoleInformationService#loadUserRoles(java.lang.String)
	 */
	@Override
	 ...
	 *            the userRolesRepository to set
	 */
	...
	/**
	 * @param roleLoginColumn
	 *            the roleLoginColumn to set
	 */
