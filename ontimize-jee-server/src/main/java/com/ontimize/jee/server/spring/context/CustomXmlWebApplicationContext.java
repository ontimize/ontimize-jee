        ...
        return new DefaultListableBeanFactory(this.getInternalParentBeanFactory()) {
            ...
            public void registerBeanDefinition(final String beanName, final BeanDefinition beanDefinition) throws BeanDefinitionStoreException {
                ...
                if (beanName.equalsIgnoreCase(AnnotationConfigUtils.PERSISTENCE_ANNOTATION_PROCESSOR_BEAN_NAME)) {
                    CustomXmlWebApplicationContext.log.warn("Skipping registration of bean (" + AnnotationConfigUtils.PERSISTENCE_ANNOTATION_PROCESSOR_BEAN_NAME + "): " + beanDefinition.getBeanClassName());
                } else {
