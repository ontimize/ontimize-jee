...
public class OntimizeConfiguration {
    ...
    @Lazy
    protected FormProviderConfiguration formProviderConfiguration;

    /** The form provider configuration */
    @Lazy
    protected SharePreferencesConfiguration sharePreferencesConfiguration;
     ...
     * @param remoteOperationConfiguration the new remote operation configuration
     */
     ...
     * @param securityConfiguration the new security configuration
     */
     ...
     * @param formProviderConfiguration the form provider configuration
     */
     ...
     * @param remotePreferencesConfiguration the remote preferences configuration
     */
     ...
     * @param mailConfiguration the new mail configuration
     */
     ...
     * @return {@link SharePreferencesConfiguration} the share preferences configuration
     */
     ...
     * @param sharePreferencesConfiguration {@link SharePreferencesConfiguration} the new share
