...
public class RemoteOperationDelegate implements IRemoteOperationListener {
     ...
     */
    public RemoteOperationDelegate(ApplicationContext context, CallbackSession session, String operationId,
     ...
     * (non-Javadoc)
     *
     * @see com.ontimize.jee.server.services.remoteoperation.IRemoteOperationListener
     * #onOperationFinished(java.lang.Object)
     */
    @Override
    public void onOperationFinished(Object result) {
        ...
        try {
            this.webSocketHandler.sendMessage(RemoteOperationStatuses.WEBSOCKET_MESSAGE_TYPE_FINISH, this.operationId,
                    msg, this.session);
        } catch (Exception error) {
            RemoteOperationDelegate.logger.error(null, error);
        }
     ...
     *
     * @see com.ontimize.jee.server.services.remoteoperation.IRemoteOperationListener
     * #onOperationError(java.lang.Object)
     */
    @Override
    ...
    private void error(Exception error) {
        try {
            this.webSocketHandler.sendMessage(RemoteOperationStatuses.WEBSOCKET_MESSAGE_TYPE_ERROR, this.operationId,
                    new RemoteOperationErrorMessage(error), this.session);
        } catch (Exception e) {
            RemoteOperationDelegate.logger.error(null, e);
        }
    }
     ...
     *
     * @see com.ontimize.jee.server.services.remoteoperation.IRemoteOperationListener
     * #onOperationStep(int, int, java.lang.String, java.lang.Object)
     */
    @Override
    public void onOperationStep(int currentStep, int maxSteps, long estimatedTime, String message,
            Object extraInformation) {
        RemoteOperationStatusMessage msg = new RemoteOperationStatusMessage(this.status, currentStep, maxSteps,
                estimatedTime, message, extraInformation);
        try {
            this.webSocketHandler.sendMessage(RemoteOperationStatuses.WEBSOCKET_MESSAGE_TYPE_STATUS, this.operationId,
                    msg, this.session);
        } catch (Exception error) {
            RemoteOperationDelegate.logger.error(null, error);
            this.error(error);
