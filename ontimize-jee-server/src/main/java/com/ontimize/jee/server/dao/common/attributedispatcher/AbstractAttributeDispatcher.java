...
public abstract class AbstractAttributeDispatcher<T> implements IAttributeDispatcher<T> {
     ...
     */
    protected EntityResult invokeQuery(ApplicationContext applicationContext, String entityName, Map<?, ?> filter,
            List<?> attributes) {
     ...
     * @return the entity result
     */
    protected EntityResult invokeUpdate(ApplicationContext applicationContext, String entityName, Map<?, ?> attr,
            Map<?, ?> keys) {
     ...
     * @param applicationContext the application context
     * @param entityName the entity name
     * @param methodSufix the method sufix
     * @param parameters the parameters
     * @return the entity result
     */
    protected EntityResult invoke(ApplicationContext applicationContext, String entityName, String methodSufix,
            Object... parameters) {
        String methodName = ServiceTools.extractServiceMethodPrefixFromEntityName(entityName)
                + StringUtils.capitalize(methodSufix);
