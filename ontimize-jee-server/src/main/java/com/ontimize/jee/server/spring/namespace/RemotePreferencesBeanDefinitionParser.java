...
public class RemotePreferencesBeanDefinitionParser extends AbstractSingleBeanDefinitionParser {
        ...
        protected void doParse(final Element element, final ParserContext ctx, final BeanDefinitionBuilder builder) {
            ...
            builder.addPropertyValue(RemotePreferencesBeanDefinitionParser.PREFERENCES_PATH,
                    DefinitionParserUtil
                        .nullIfEmpty(element.getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_FILEPATH)));
            builder.setLazyInit(true);
        }
    ...
    public static class DatabaseRemotePreferencesParser extends AbstractSingleBeanDefinitionParser {
        ...
        @Override
        protected void doParse(final Element element, final ParserContext ctx, final BeanDefinitionBuilder builder) {
            builder.addPropertyReference("dao", DefinitionParserUtil
                .nullIfEmpty(element.getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_REF_REPOSITORY)));
            builder.addPropertyValue("userColumnName", DefinitionParserUtil
                .nullIfEmpty(element.getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_USER_COLUMN_NAME)));
            builder.addPropertyValue("preferenceNameColumnName",
                    DefinitionParserUtil.nullIfEmpty(element
                        .getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_PREF_NAME_COLUMN_NAME)));
            builder.addPropertyValue("preferenceValueColumnName",
                    DefinitionParserUtil.nullIfEmpty(element
                        .getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_PREF_VALUE_COLUMN_NAME)));
            builder.addPropertyValue("queryId", DefinitionParserUtil
                .nullIfEmpty(element.getAttribute(RemotePreferencesBeanDefinitionParser.PREFERENCES_QUERY_ID)));
            builder.setLazyInit(true);
        }
