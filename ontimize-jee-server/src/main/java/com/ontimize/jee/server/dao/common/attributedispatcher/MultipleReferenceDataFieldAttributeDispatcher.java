...
public class MultipleReferenceDataFieldAttributeDispatcher extends AbstractAttributeDispatcher<MultipleReferenceDataFieldAttribute> {

	@Override
	public void processQueryAttribute(MultipleReferenceDataFieldAttribute multipleAttr, EntityResult result, ApplicationContext applicationContext) {
