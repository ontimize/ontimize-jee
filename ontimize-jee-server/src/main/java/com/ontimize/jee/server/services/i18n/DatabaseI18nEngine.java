...
public class DatabaseI18nEngine implements II18nService, InitializingBean {
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.i18n.II18nService#getBundles(java.util.List, java.util.Locale)
	 */
	@Override
	public Map<String, ResourceBundle> getBundles(List<String> baseNames, Locale locale) throws OntimizeJEERuntimeException {
		Map<String, ResourceBundle> result = new Hashtable<>();
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.i18n.II18nService#getBundle(java.lang.String, java.util.Locale)
	 */
	@Override
	...
	/*
	 * (non-Javadoc)
	 * @see com.ontimize.jee.common.services.i18n.II18nService#updateBundleValues(com.ontimize.gui.i18n.DatabaseBundleValues)
	 */
	@Override
	 ...
	 * @param bundleClassName
	 *            the bundle class name
	 * @param availablebundles
	 *            the availablebundles
	...
	public void afterPropertiesSet() throws Exception {
		CheckingTools.failIfEmptyString(this.bundleClassNameColumn, "No i18n database property classNameColumn defined");
		CheckingTools.failIfEmptyString(this.bundleDescriptionColumn, "No i18n database property descriptionColumn defined");
		CheckingTools.failIfEmptyString(this.bundleKeyColumn, "No i18n database property keyColumn defined");
		CheckingTools.failIfEmptyString(this.bundleValuesKeyColumn, "No i18n database property valuesKeyColumn defined");
		CheckingTools.failIfEmptyString(this.bundleValuesTextKeyColumn, "No i18n database property valuesTextKeyColumn defined");
	 ...
	 *
	 * @param bundleClassNameColumn
	 *            the bundleClassNameColumn to set
	 */
	 ...
	 *
	 * @param bundleDescriptionColumn
	 *            the bundleDescriptionColumn to set
	 */
	 ...
	 *
	 * @param bundleKeyColumn
	 *            the bundleKeyColumn to set
	 */
	 ...
	 *
	 * @param bundleValuesKeyColumn
	 *            the bundleValuesKeyColumn to set
	 */
	 ...
	 *
	 * @param bundleValuesTextKeyColumn
	 *            the bundleValuesTextKeyColumn to set
	 */
	 ...
	 *
	 * @param daoBundleValues
	 *            the daoBundleValues to set
	 */
	 ...
	 *
	 * @param localeColumnNames
	 *            the localeColumnNames to set
	 */
