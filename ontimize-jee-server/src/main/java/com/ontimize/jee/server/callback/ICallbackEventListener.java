...
/**
 * The listener interface for receiving IWebSocketMessage events. The class that is interested in
 * processing a IWebSocketMessage event implements this interface, and the object created with that
 * class is registered with a component using the component's
 * <code>addIWebSocketMessageListener<code> method. When the IWebSocketMessage event occurs, that
