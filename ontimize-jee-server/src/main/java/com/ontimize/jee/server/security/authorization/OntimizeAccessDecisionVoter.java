...
public class OntimizeAccessDecisionVoter implements AccessDecisionVoter<Object>, ApplicationContextAware {
    ...
    public boolean supports(final ConfigAttribute configattribute) {
        return true;// & ((this.defaultVoter == null) || ((this.defaultVoter != null) &&
                    // this.defaultVoter.supports(configattribute)));
    }
     ...
     * @param defaultVoter the defaultVoter to set
     */
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        ...
        CheckingTools.failIfNull(ontimizeConfiguration.getSecurityConfiguration(),
                I18NNaming.E_NO_ONTIMIZE_CONFIGURATION_DEFINED);
