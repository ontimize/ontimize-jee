...
public class OntimizeRequestHeadersServletFilter implements Filter {
    ...
    public void doFilter(final ServletRequest request, final ServletResponse response, final FilterChain filterChain)
        ...
        if (request instanceof HttpServletRequest) {
            ...
            final OntimizeRequestHeaderProcessorFilters filters = SpringApplicationContext.getContext()
                .getBean(OntimizeRequestHeaderProcessorFilters.class);
            ...
            try {
                ...
                OntimizeRequestHeadersServletFilter.logger
                    .debug("[APP TIME] Request headers Filter Processing time: " + time + " ms");
            }
        }
    }
